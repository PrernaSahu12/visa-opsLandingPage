    ...
    <header className="fixed top-0 left-0 right-0 z-40">
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-5 lg:gap-7">
          ...
          {/* Fintech-style Login & Get Started Pill Buttons */}
          <div className="flex items-center gap-2.5">
            <button
              onClick={onOpenDemo}
              className="px-5 py-1.5 rounded-full border-2 border-[#102A56] bg-white hover:bg-[#102A56] text-[#102A56] hover:text-white font-bold text-xs lg:text-sm tracking-wide transition-all active:scale-[0.98]"
            >
              Login
            </button>
        ...
        <div className="md:hidden bg-white border-b border-[#E2E8F0] px-5 py-6 space-y-4 shadow-xl animate-in slide-in-from-top-4 duration-200">
          ...
          <div className="pt-4 border-t border-[#E2E8F0] flex flex-col gap-2.5">
            <button
              ...
              className="w-full py-2.5 rounded-full border-2 border-[#102A56] bg-white text-[#102A56] font-bold text-sm tracking-wide"
            >
              Login
            </button>
            <a
